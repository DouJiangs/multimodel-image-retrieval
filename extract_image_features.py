...
def get_cnn_features(save, image_list, split, batch_size, dataset_name, pretrained_cnn, pretrained_cnn_name):
    ...
    """
    # create hdf5 file
    hdf5_path = "%s/%s_%s_%s_%s" % (save, dataset_name, split, pretrained_cnn_name, "cnn_features.hdf5")
...
def make_dataset(args):
    ...
    for split in data:
        ...
        get_cnn_features(args.save, files, split, args.batch_size, args.dataset_name, cnn, args.pretrained_cnn)
