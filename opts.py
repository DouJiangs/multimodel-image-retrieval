...
def train_mm_opts(parser):
    ...
    parser.add_argument('-img_train_feat', default=None, type=str,#required=True,
    ...
    parser.add_argument('-img_valid_feat', default=None, type=str,#required=True,
                        help="""Path to hdf5 file containing training image features""")
...
def translate_mm_opts(parser):
    parser.add_argument('-img_test_feat',default=None, type=str,#required=True,
